...
public class MasterRenderer {
	...
	private static final Vector4f BACKGROUND = new Vector4f(0,1,1,1); //cyan
	...
	public MasterRenderer() {
		//This avoids rendering the faces that we do not see
	...
	public void prepare() {
		...
		GL11.glClearColor(BACKGROUND.x,BACKGROUND.y,BACKGROUND.z,BACKGROUND.w); //Background 
	}
