...
public class TerrainShader extends ShaderProgram{
	...
	private static final String VERTEX_FILE = "src/shaders/terrainVertexShader.txt";     //Location of the vertex GLSL code
	private static final String FRAGMENT_FILE = "src/shaders/terrainFragmentShader.txt"; //Location of the fragment GLSL code
